...
import com.turkishairlines.selector.Selector;
import com.turkishairlines.selector.SelectorFactory;
import com.turkishairlines.selector.SelectorType;
    ...
    public void beforeScenario() throws MalformedURLException {
        ...
        if (StringUtils.isEmpty(System.getenv("key"))) {
            if (localAndroid) {
                ...
                desiredCapabilities.setCapability("avd", "NEXUS_5X");
                desiredCapabilities
